...
let i:number=0,j:number = 0 //initializing trackers for current text and query iterations
...
else{i++,j++}//if there was no error, move over to the next text and query character (iteration)
}
